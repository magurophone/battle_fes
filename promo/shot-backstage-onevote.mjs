...
try {
  await page.goto(`http://127.0.0.1:${port}/promo/backstage-onevote.html`, { waitUntil: "networkidle" });
  await page.evaluate(() => document.fonts.ready);
  await page.waitForTimeout(350);
  await page.screenshot({ path: "public/assets/promo/backstage-3-onevote.png" });
  console.log("saved public/assets/promo/backstage-3-onevote.png");
} finally {
  await browser.close();
  server.close();
}

...
const shots = [
  ["hero", "public/assets/promo/sns-unified-hero.png"],
  ["value", "public/assets/promo/sns-unified-value.png"],
];
...
try {
  for (const [scene, out] of shots) {
    await page.goto(`http://127.0.0.1:${port}/promo/sns-unified.html?scene=${scene}`, {

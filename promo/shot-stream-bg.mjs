...
const shots = [
  ["opening", "public/assets/promo/stream-bg-opening.png"],
  ["result", "public/assets/promo/stream-bg-result.png"],
];
...
try {
  for (const [scene, out] of shots) {
    await page.goto(`http://127.0.0.1:${port}/promo/stream-bg.html?scene=${scene}`, {
